...
| 0008 | [Précision du central](0008-precision-central-hyperparametres.md) | 2026-08-10 | hyperparamètres réglés pour le central seul (MAE 1 482 → **1 366 €**) ; refusés pour les bornes — la couverture du haut de gamme s'effondrait à 64 % ; garantie bit-pour-bit identique |
